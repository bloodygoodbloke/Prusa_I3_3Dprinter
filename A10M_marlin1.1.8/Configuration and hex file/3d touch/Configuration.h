...
#define PID_K1 0.95      // Smoothing factor within the PID
  ...
  // MeCreator2
#define  DEFAULT_Kp 104.15  //11.93
#define  DEFAULT_Ki 17.91  //0.59
#define  DEFAULT_Kd 151.44  //59.89
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 85.03   // 175.68 189.95 
  #define  DEFAULT_bedKi 12.66    //  34.59  37.40
  #define  DEFAULT_bedKd 142.80   // 223.07 241.19
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.8, 80.48, 399.97, 445.33 }   //Orig { 80, 80, 4000, 500 } 93*2 = DRV8825 1/32 Stepps
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -3.30 //-0.50 // Z offset: -below +above  [the nozzle]
