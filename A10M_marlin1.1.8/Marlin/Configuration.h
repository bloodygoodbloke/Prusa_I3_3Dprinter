...
#define CUSTOM_MACHINE_NAME "Kris's A10M"
...
#define PID_K1 0.95      // Smoothing factor within the PID
  ...
  // MeCreator2
#define  DEFAULT_Kp 121.77  //11.93
#define  DEFAULT_Ki 21.23  //0.59
#define  DEFAULT_Kd 174.57  //59.89
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 47.33  // 175.68 189.95 
  #define  DEFAULT_bedKi 9.17    //  34.59  37.40
  #define  DEFAULT_bedKd 61.07   // 223.07 241.19
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.65, 80.33, 400.45, 445.45 }   //Orig { 80, 80, 4000, 500 } 93*2 = DRV8825 1/32 Stepps
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION       { 5000, 5000, 60, 5000 } //1.0.3 { 3000, 3000, 100, 10000 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.55 //-0.50 // Z offset: -below +above  [the nozzle]
...
//#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 322.8427124746
  #define XY_DIAG_BD 322.8427124746
  #define XY_SIDE_AD 230
  ...
  //#define SKEW_CORRECTION_FOR_Z
    ...
    #define XZ_DIAG_AC 322.8427124746
    #define XZ_DIAG_BD 322.8427124746
    #define YZ_DIAG_AC 322.8427124746
    #define YZ_DIAG_BD 322.8427124746
    #define YZ_SIDE_AD 230
